...
<main>
  <fieldset>
    <input type="checkbox" id="toggleMode" aria-label="darkmode button">
    <label for="toggleMode" class="toggleDark" aria-label="go to lightmode">
    ...
    <label for="toggleMode" class="toggleLight" aria-label="go to darkmode">
      <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <section id="names">
    ...
    <fieldset class="filters" aria-label="kies een squad">
      <label for="1d">
        <input type="radio" 
                name="squad" 
                id="1d" 
